...
public class MusicService extends Service implements OnCompletionListener, OnPreparedListener,
    ...
    // AndroidManifest.xml.
    public static final String ACTION_PLAY = "com.example.hellotabwidget.action.URL";
    public static final String ACTION_PAUSE = "com.example.hellotabwidget.action.PAUSE";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (action.equals(ACTION_PLAY)) processPlayRequest(intent);
        else if (action.equals(ACTION_PAUSE)) processStopRequest();
    ...
    void processPlayRequest(Intent intent) {
        ...
        if (mState == State.Retrieving) {
            ...
            Log.i(TAG, "Playing from CJSF FM 90.1");
            tryToGetAudioFocus();
    ...
    void playNextSong(String manualUrl) {
        ...
        try {
            ...
            setUpAsForeground("CJSF Radio FM 90.1 (loading)");
